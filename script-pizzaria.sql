...
-- Selecionar todas as pizzas com valorigual ou inferior a R$ 17,00
select * from pizzas where valor <= 17 ;

-- Selecionar todas as pizzas com valor igaul a R$ 17,00
select * from pizzas where valor = 17 ; 
...
-- Selecionar todas as pizzas com valores entre R$ 15,00 R$20,00
select * from pizzas where valor > 15 and valor <20;
select * from pizzas where valor between 16 and 19;

-- Selecionar todas as pizzas com valores menores e maiores do que  R$ 17,00 
select * from pizzas where valor < 17 or valor > 17;

-- Selecionar todas as pizzas com valores não menores e maiores do que  R$ 17,00 
...
-- Selecionar todas as pizzas com valores fora da faixa de R$ 17,00 e R$ 20,00
...
-- Selecionar todas as pizzas com valores igual a  R$ 15,00 R$20,00
select * from pizzas where valor = 15 or valor = 20;
select * from pizzas where valor in (15,20);

-- Selecionar todas as pizzas com valores diferente a  R$ 15,00 R$20,00
select * from pizzas where valor != 15 and valor != 20;
...
-- Listar todas as colunas da tabela PIZZA em ordem decrescente e o nome em ordem alfabética
...
select valor,nome from pizzas order by 1;
